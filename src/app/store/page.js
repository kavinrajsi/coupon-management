...
export default function StorePanel() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.couponCode || !formData.employeeCode || !formData.storeLocation) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Store Panel</h1>
                <p className="text-sm text-gray-500">Validate and manage coupon codes</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-white">Coupon Validation</h2>
                    <p className="text-blue-100 text-sm">Enter coupon details to validate and process</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute right-3 top-3 text-gray-400">
                        <span className="text-sm">{formData.couponCode.length}/6</span>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      {Array.from({length: 18}, (_, i) => (
                        <option key={i + 1} value={String(i + 1)}>
                          Store {i + 1} {i + 1 === 1 ? '(Main Branch)' : i + 1 === 5 ? '(Downtown)' : i + 1 === 10 ? '(Mall)' : ''}
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                {message && (
                  <div className={`mt-6 p-4 rounded-xl border-l-4 ${
                    message.includes('Error') || message.includes('not') || message.includes('already')
